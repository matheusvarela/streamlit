...
st.title("Gerador de Imagens com Stable Diffussion")

def generate_images(prompt,
                    negative_prompt, 
                    num_images_per_prompt,
                    num_inference_steps,
                    height,width,seed,guidance_scale):
...
with st.sidebar:
    ...
    st.header("Configurações de geração da imagem")
    ...
    generate_button = st.button("Gerar Imagens")
