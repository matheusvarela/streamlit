...
if process_button and upload_file is not None:
    ...
    try:
        ...
        if data.empty or data.iloc[:,0].isnull().all():
            ...
            st.error("O arquivo está vazio ou primeira coluna não tem dados válidos")
            ...
            if shapiro_test.pvalue > 0.5:
                ...
                st.warning("Existem evidências suficientes para rejeitar a hipotese de normalidade dos dados")
